!(function(e, t) {
  ...
  var u = 'function' == typeof Symbol && Symbol.for,
    ...
    N = u ? Symbol.for('react.scope') : 60119
  function x(e) {
  ...
  function be(e, t, n) {
    ...
    return (
      t === pe && (e = ye(e, Fe(e) % 10, 'year')),
      t === de && (e = ye(e, Fe(e) % 100, 'year')),
      t === le &&
        (e = (function(e, t, n) {
          var r = (je(e) + 7 - (n || 0)) % 7
  ...
  function Ye(e) {
    return 0 === Ce(e) && 0 === ke(e) && 0 === Re(e) && 0 === xe(e)
  }
  function $e(e, t, n) {
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            O = h.start(o),
            T = h.allDay(o),
            N = c || T || $e(O, Ue(M, 'day'), 'day') > 1,
            x = m.eventProp(o, O, M, i),
            R = r.createElement(
              'div',
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              a({}, _, {
                tabIndex: 0,
                style: a({}, x.style, t),
                className: X('rbc-event', n, x.className, {
                  'rbc-selected': i,
                  'rbc-event-allday': N,
        ...
        return r.createElement(
          ...
          t.map(function(e, t) {
            return r.createElement(an, {
              ...
              components: s,
              onDoubleClick: l,
              continuesPrior: De(i.end(e), u, 'day'),
              continuesAfter: Se(i.start(e), f, 'day'),
              slotStart: u,
              slotEnd: f,
              selected: sn(e, n),
            })
  ...
  function Pn(e) {
    return jn({}, e, { right: e.left + e.width, bottom: e.top + e.height })
  }
  function An(e) {
    var t = {}
    try {
    ...
    var o = {
      ...
      i = 'HTML' === e.nodeName ? xn(e.ownerDocument) : {},
  ...
  function zn(e, t, n) {
    ...
    return Fn(n, r ? Ln(t) : Mn(t, bn(n)), r)
  }
  function Hn(e) {
      ...
      modifiers: {
        ...
        computeStyle: {
          ...
          fn: function(e, t) {
            ...
            return (
              (e.attributes = jn({}, y, e.attributes)),
              (e.styles = jn({}, l, e.styles)),
              (e.arrowStyles = jn({}, e.offsets.arrow, e.arrowStyles)),
              e
            )
          },
          gpuAcceleration: !0,
    ...
    sr = (function() {
      function e(t, n) {
        ...
        Rn(this, e),
          ...
          (this.options = jn({}, e.Defaults, o)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = t && t.jquery ? t[0] : t),
          (this.popper = n && n.jquery ? n[0] : n),
          (this.options.modifiers = {}),
          Object.keys(jn({}, e.Defaults.modifiers, o.modifiers)).forEach(
            function(t) {
              r.options.modifiers[t] = jn(
                {},
          ...
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function(e) {
              return jn({ name: e }, r.options.modifiers[e])
            })
            .sort(function(e, t) {
  ...
  function wr(e, n, r) {
    ...
    t.useEffect(
      function() {
        if (!a && null != e) {
          var t,
            n = ((t = e.current), Ft(o.findDOMNode(t))),
            r = vr(n, c, f, !0),
            i = vr(n, c, p),
            s = vr(n, 'keyup', d),
            l = []
  ...
  var Cr = (function() {
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && jr(t, Pr(e))
      }),
      (t.filter = function(e) {
  ...
  var Ei = no(Ze, 'DataView'),
    ...
    xi = Xr(Di),
    Ri = st
  ;((Ei && '[object DataView]' != Ri(new Ei(new ArrayBuffer(1)))) ||
    (ro && '[object Map]' != Ri(new ro())) ||
    (_i && '[object Promise]' != Ri(_i.resolve())) ||
    ...
    Ca = (function(e) {
      ...
      return (
        ...
        (n.canRenderSlotEvent = function(e, t) {
          ...
          return xa(e, e + t).every(function(e) {
            return 1 === ka(n, e)
          })
        }),
      ...
      return (
        ...
        (o.render = function() {
          var e = this.props,
            ...
            o = e.className,
            i = (function(e, t, n) {
              t = (n ? wt(e, t, n) : void 0 === t) ? 1 : At(jt(t), 0)
              var r = null == e ? 0 : e.length
              if (!r || t < 1) return []
    ...
    return (
      ...
      ),
      {
        ...
        dateIsInGroup: function(e, t) {
          var r = p[t + 1]
          return Ne(e, p[t][0], r ? r[0] : n, 'minutes')
        },
        nextSlot: function(e) {
      ...
      return (
        ...
        (t._selectable = function() {
          var e = n.findDOMNode(re(t)),
            ...
            i = function(n) {
              var r = t.slotMetrics.closestSlotFromPoint(n, Pr(e))
          ...
          r.on('selecting', o),
            ...
            r.on('beforeSelect', function(e) {
              if ('ignoreEvents' === t.props.selectable)
                return !Rr(n.findDOMNode(re(t)), e)
            }),
            r.on('click', function(e) {
              return s(e, 'click')
            }),
        ...
        (t._selectSlot = function(e) {
          for (
            ...
            c.push(s), (s = ge(s, t.props.step, 'minutes'))
      ...
      groupEvents: function(n) {
        ...
        return e
          ? (n.forEach(function(e) {
              ;(t.resource(e) || Os).forEach(function(t) {
                var n = r.get(t) || []
                n.push(e), r.set(t, n)
              })
            }),
  ...
  var Ns = (function(e) {
    function t(t) {
      ...
      return (
        ...
        (o.memoizedResources = Pa(function(e, t) {
          return Ts(e, t)
        })),
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          o = s(e, ['date']),
          i = t.range(n)
        return r.createElement(Ns, a({}, o, { range: i, eventOffset: 10 }))
      }),
      t
    )
  })(r.Component)
  ...
  var Rs = (function(e) {
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(Ns, a({}, o, { range: i, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  function ks(e, t) {
    return Rs.range(e, t).filter(function(e) {
      return -1 === [6, 0].indexOf(e.getDay())
    })
  }
  ;(Rs.propTypes = {}),
    (Rs.defaultProps = Ns.defaultProps),
    (Rs.navigate = function(e, t) {
      switch (t) {
        case q.PREVIOUS:
          return ge(e, -1, 'week')
        case q.NEXT:
    ...
    (Rs.range = function(e, t) {
      var n = t.localizer.startOfWeek()
      return Ve(be(e, 'week', n), we(e, 'week', n))
    }),
    (Rs.title = function(e, t) {
      var n = t.localizer,
        r = Rs.range(e, { localizer: n }),
        o = r[0],
        i = r.slice(1)
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          n = s(e, ['date']),
          o = ks(t, this.props)
        return r.createElement(Ns, a({}, n, { range: o, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  ...
  ;(Cs.propTypes = {}),
    (Cs.defaultProps = Ns.defaultProps),
    (Cs.range = ks),
    (Cs.navigate = Rs.navigate),
      ...
      return (
        ((n = e.call(this, t) || this).renderDay = function(e, t, o) {
          ...
          return (t = t.filter(function(t) {
            return Sa(t, be(e, 'day'), we(e, 'day'), c)
          })).map(function(i, u) {
            var d = c.title(i),
              h = c.end(i),
              m = c.start(i),
              v = s.eventProp(i, m, h, sn(i, a)),
          ...
          return (
            i.allDay(t) ||
              (Ee(f, u)
                ...
                : Ee(e, f, 'day')
                ? (l = a.format(f, 'agendaTimeFormat'))
                : Ee(e, u, 'day') && (l = a.format(u, 'agendaTimeFormat'))),
            _e(e, f, 'day') && (s = 'rbc-continues-prior'),
            De(e, u, 'day') && (s += ' rbc-continues-after'),
            r.createElement(
              'span',
              { className: s.trim() },
          ...
          if (n.tbodyRef.current) {
            ...
            if (t) {
              var r,
                ...
                a = n._widths || []
              ;(n._widths = [_s(t.children[0]), _s(t.children[1])]),
  ...
  function Fs(e) {
    var t = e.style,
      ...
      M = t.xOffset,
      O = [
        r.createElement('div', { key: '1', className: 'rbc-event-label' }, c),
        r.createElement(
          'div',
          { key: '2', className: 'rbc-event-content' },
          m ? r.createElement(m, { event: o, title: g }) : g
        ),
      ]
    return r.createElement(
      v,
      ...
      r.createElement(
        'div',
        {
          ...
          className: X('rbc-event', n, E.className, {
            'rbc-selected': s,
  ...
  ;(Ps.propTypes = {}),
    ...
    (Ps.range = function(e, t) {
      ...
      return {
        start: e,
        end: ge(e, void 0 === n ? Ps.defaultProps.length : n, 'day'),
      }
    }),
    (Ps.navigate = function(e, t, n) {
      var r = n.length,
        o = void 0 === r ? Ps.defaultProps.length : r
      switch (t) {
        case q.PREVIOUS:
          return ge(e, -o, 'day')
        case q.NEXT:
      ...
      return (
        ...
        (t._selectable = function() {
          var e = n.findDOMNode(re(t)),
            ...
            i = function(n) {
              var r = t.slotMetrics.closestSlotFromPointForRow(n, Pr(e))
              t.state.selecting || (t._initialSlot = r)
              var o = t._initialSlot
              Me(o, r)
                ? (r = t.slotMetrics.nextSlot(r))
        ...
        return r.createElement(
          ...
          b.groups.map(function(e, t) {
            return r.createElement(
              ...
              e.map(function(e, t) {
                var n = d ? d.slotProp(e, c) : {}
                return r.createElement(
                  g,
                  { key: t, value: e, resource: c },
                  r.createElement(
                    'div',
                    a({}, n, { className: X('rbc-time-slot', n.className) })
                  )
                )
              })
            )
          ...
          r.createElement(
            ...
            r.createElement(
              'div',
              { className: X('rbc-events-container-scheduler', n && 'rtl') },
              this.renderEvents()
            )
          ),
          E &&
            r.createElement(
              ...
              r.createElement('span', null, u.format(D, 'selectRangeFormat'))
            ),
          o &&
            r.createElement('div', {
  ...
  ;(Ls.propTypes = {}),
    (Ls.defaultProps = { dragThroughEvents: !0, timeslots: 2 })
  var Is = (function(e) {
    function t() {
      for (var t, n = arguments.length, r = new Array(n), o = 0; o < n; o++)
        r[o] = arguments[o]
      return (
        ((t = e.call.apply(e, [this].concat(r)) || this).slotMetrics = Ba(
          t.props
        )),
        t
      )
    ...
    return (
      (n.renderHeaderCells = function(e) {
        var t = this,
          ...
          u = a(),
          f = i(e),
          p = o.format(e, 'dayFormat'),
          d = s(e),
          h = d.className,
          m = d.style,
          v = r.createElement(l, { date: e, label: p, localizer: o })
        return r.createElement(
          'div',
          {
            style: m,
            className: X('rbc-header', h, Ee(e, u, 'day') && 'rbc-today'),
          },
          f
            ? r.createElement(
                'a',
                {
                  href: '#',
                  onClick: function(n) {
                    return t.handleHeaderClick(e, f, n)
                  },
                },
                v
              )
      ...
      (n.render = function() {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            {
              style: v,
              className: X(m, 'rbc-day-slot', 'rbc-time-header-row'),
            },
            d.groups.map(function(e, t) {
              return r.createElement(
                'div',
                { key: t, className: 'rbc-timeslot-row-group' },
                e.map(function(e, t) {
                  var i = u ? u.slotProp(e, n) : {}
                  return r.createElement(
                    p,
                    { key: t, value: e, resource: n },
                    r.createElement(
                      'div',
                      a({}, i, { className: X('rbc-time-slot', i.className) }),
    ...
    return (
      ...
      (o.componentWillReceiveProps = function(e) {
        var t = this.props,
          n = t.range,
          r = t.scrollToDay
        ;(Ee(e.range[0], n[0], 'minute') && Ee(e.scrollToDay, r, 'minute')) ||
          (this.calculateScroll(e), this.applyScroll())
      }),
      (o.renderEvents = function(e, t, n) {
        var o = this,
          i = this.props,
        ...
        return p.map(function(t, i) {
          ...
          return r.createElement(
            ...
            o.renderDay(e, d, p, c, u, a, s, h, l, n, i, f)
          )
        })
      }),
      (o.renderDay = function(e, t, n, o, i, s, c, l, u, f, p, d) {
        var h = this
        return e.map(function(e, m) {
          var v = (t.get(n) || []).filter(function(t) {
        ...
        return (
          n.forEach(function(e) {
            if (Sa(e, b, w, u)) {
              var t = u.start(e),
                n = u.end(e)
              u.allDay(e) || (Ye(t) && Ye(n)) || (!h && !Ee(t, n, 'day'))
                ? E.push(e)
                : _.push(e)
            }
          }),
          ...
          r.createElement(
            'div',
            { className: X('rbc-time-view-row', 'rbc-time-view-resources') },
            r.createElement(
              'div',
              { ref: this.scrollRef, className: X('rbc-time-header') },
              r.createElement(
                'div',
                {
            ...
            r.createElement(
              ...
              {
                ref: this.contentRef,
                className: X('rbc-time-content-scheduler'),
                onScroll: this.handleScroll,
              },
              c &&
                r.createElement(
                  'div',
                  {
                    className: X('rbc-time-column', 'rbc-time-gutter'),
                    ref: this.gutterRef,
                  },
  ...
  ;(Hs.propTypes = {}),
    (Hs.defaultProps = Ws.defaultProps),
  ...
  function Vs(e, t) {
    ...
    switch (((e = 'string' == typeof e ? Us[e] : e), n)) {
      case q.TODAY:
        r = o || new Date()
        break
      case q.DATE:
  ...
  function Xs(e, t, n) {
    var r = e[t]
    ;(Gs.call(e, t) && Xe(r, n) && (void 0 !== n || t in e)) || $s(e, t, n)
  }
  function qs(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var i = -1, a = t.length; ++i < a; ) {
      ...
      void 0 === c && (c = e[s]), o ? $s(n, s, c) : Xs(n, s, c)
    }
    return n
  }
  ...
  function Zs(e) {
    ...
    var t = di(e),
      n = []
    for (var r in e) ('constructor' != r || (!t && Ks.call(e, r))) && n.push(r)
    return n
  }
  function Js(e) {
    return vt(e) ? fi(e, !0) : Zs(e)
  }
  var Qs = 'object' == typeof e && e && !e.nodeType && e,
    ec =
      Qs && 'object' == typeof module && module && !module.nodeType && module,
    tc = ec && ec.exports === Qs ? Ze.Buffer : void 0,
    nc = tc ? tc.allocUnsafe : void 0
  var rc = hi(Object.getPrototypeOf, Object),
    oc = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) Wo(t, Yo(e)), (e = rc(e))
          return t
        }
      : Uo
  function ic(e) {
  ...
  var cc = /\w*$/
  var lc = Je ? Je.prototype : void 0,
    uc = lc ? lc.valueOf : void 0
  ...
  function Rc(e, t, n) {
    ...
    switch (t) {
      ...
      case mc:
        return (
          ((i = new (o = e).constructor(o.source, cc.exec(o))).lastIndex =
            o.lastIndex),
          i
        )
      case vc:
        return new a()
      case yc:
        return (r = e), uc ? Object(uc.call(r)) : {}
    }
  }
    ...
    i.set(e, a),
      Ic(e)
        ? e.forEach(function(r) {
            a.add(Gc(r, t, n, r, e, i))
          })
        : Ac(e) &&
          e.forEach(function(r, o) {
            a.set(o, Gc(r, t, n, o, e, i))
          })
    var h = l ? (c ? ic : yi) : c ? keysIn : gi,
      m = u ? void 0 : h(e)
    return (
      Ys(m || e, function(r, o) {
        m && (r = e[(o = r)]), Xs(a, o, Gc(r, t, n, o, e, i))
      }),
      a
    )
  }
  ...
  ;($c[Uc] = $c['[object Array]'] = $c['[object ArrayBuffer]'] = $c[
    '[object DataView]'
  ...
  function tl(e) {
    return (function(e) {
      if (!Et(e) || st(e) != qc) return !1
      var t = rc(e)
      if (null === t) return !0
      var n = Qc.call(t, 'constructor') && t.constructor
      return 'function' == typeof n && n instanceof n && Jc.call(n) == el
    })(e)
      ? void 0
      : e
  }
    ...
    al = cs(function(e, t) {
      ...
      for (o && wt(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = Js(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Xe(u, ol[l]) && !il.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var sl = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = ya(t)), null == n)) {
                  ...
                  n = o ? (r ? new i() : []) : ct(e) && dt(i) ? Cc(rc(e)) : {}
                }
                return (
                  (o ? Ys : Ka)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            p = c()
          l(
            (i = Vs(f, a({}, u, { action: e, date: n || i || p, today: p }))),
            o,
            e
          ),
  ...
  var dl = function(e, t, n) {
    ...
    hl = {
      ...
      dayFormat: 'ddd dd/MM',
      weekdayFormat: 'ddd',
      selectRangeFormat: dl,
      eventTimeRangeFormat: dl,
      eventTimeRangeStartFormat: function(e, t, n) {
        var r = e.start
  ...
  var yl = function(e, t, n) {
    ...
    wl = { eventWrapper: i, timeSlotWrapper: i, dateCellWrapper: i }
  ;(e.Calendar = ul),
    (e.DateLocalizer = ee),
    (e.Navigate = q),
    (e.Views = K),
