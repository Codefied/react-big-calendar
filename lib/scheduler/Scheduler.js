...
var _TimeGrid = _interopRequireDefault(require('../scheduler/TimeGrid'))

var Scheduler = /*#__PURE__*/ (function(_React$Component) {
  ;(0, _inheritsLoose2.default)(Scheduler, _React$Component)
...
Scheduler.propTypes =
  process.env.NODE_ENV !== 'production'
    ...
    : {}
Scheduler.defaultProps = _TimeGrid.default.defaultProps
