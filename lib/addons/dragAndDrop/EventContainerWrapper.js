...
var _TimeGridEvent = _interopRequireDefault(
  require('../../scheduler/TimeGridEvent')
)

var _TimeGridEvent2 = _interopRequireDefault(require('../../TimeGridEvent'))
...
var pointInRow = function pointInRow(bounds, point) {
  var x = point.x,
    y = point.y
  var left = bounds.left,
    right = bounds.right,
...
var EventContainerWrapper = /*#__PURE__*/ (function(_React$Component) {
  ...
  function EventContainerWrapper() {
    ...
    _this.handleMove = function(point, boundaryBox) {
      ...
      var _this$props = _this.props,
        ...
        onSchedulerView = _this$props.onSchedulerView
      ...
      if (onSchedulerView) {
        currentSlot = slotMetrics.closestSlotFromPointForRow(
          {
            y: point.y,
            x: point.x - _this.eventOffsetLeft,
          },
          boundaryBox
        )
      } else {
    ...
    _this.handleDropFromOutside = function(point, boundaryBox) {
      var _this$props2 = _this.props,
        ...
        onSchedulerView = _this$props2.onSchedulerView
      var start
  ...
  _proto.handleResize = function handleResize(point, boundaryBox) {
    var start, end, currentSlot
    var _this$props3 = this.props,
      accessors = _this$props3.accessors,
      slotMetrics = _this$props3.slotMetrics,
      onSchedulerView = _this$props3.onSchedulerView
  ...
  _proto.render = function render() {
    var _this$props4 = this.props,
      ...
      onSchedulerView = _this$props4.onSchedulerView
    ...
    return /*#__PURE__*/ _react.default.cloneElement(children, {
      children: /*#__PURE__*/ _react.default.createElement(
        ...
        event &&
          !onSchedulerView &&
          /*#__PURE__*/ _react.default.createElement(_TimeGridEvent2.default, {
            event: event,
            label: label,
            className: 'rbc-addons-dnd-drag-preview',
            style: {
...
EventContainerWrapper.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
        ...
        onSchedulerView: _propTypes.default.bool,
      }
    : {}
EventContainerWrapper.propTypes =
